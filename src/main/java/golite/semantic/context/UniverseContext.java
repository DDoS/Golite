...
public final class UniverseContext extends Context {
    public static final Variable TRUE_VARIABLE = new Variable("true", BasicType.BOOL, true);
    public static final Variable FALSE_VARIABLE = new Variable("false", BasicType.BOOL, true);
