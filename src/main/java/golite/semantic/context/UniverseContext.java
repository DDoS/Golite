...
public final class UniverseContext extends Context {
    public static final Variable TRUE_VARIABLE = new Variable(0, 0, 0, 0, "true", BasicType.BOOL);
    public static final Variable FALSE_VARIABLE = new Variable(0, 0, 0, 0, "false", BasicType.BOOL);
